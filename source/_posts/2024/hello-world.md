...
这次选择了 Hexo + Markdown。虽然一般都是用这个做博客的，但我选了这个 [Stellar：开始您全新的博客之旅 - XAOXUU](https://xaoxuu.com/wiki/stellar/) 主题，内置了 wiki 系统。我只是想把一些整理过的 [笔记](https://gocalf.com/notes/) 放出来。
