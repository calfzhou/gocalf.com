...
跟 [3042. Count Prefix and Suffix Pairs I](../3042-count-prefix-and-suffix-pairs-i/index.md) 一模一样，但单词数量从 50 提升到 10⁵，同时单词的长度也从 10 提升到 10⁵。
...
[3042. Count Prefix and Suffix Pairs I](../3042-count-prefix-and-suffix-pairs-i/index.md) 的时间复杂度是 `O(k * n²)`。
...
> Trie 树的实现和相关操作参考 [208. Implement Trie (Prefix Tree)](../208-implement-trie-prefix-tree/index.md)。
