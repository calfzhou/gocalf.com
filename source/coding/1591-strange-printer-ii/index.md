...
跟 [664. Strange Printer](../664-strange-printer/index.md) 似乎没有太大关联，除了都是「打印机」。
...
判定图中是否有环可以参考 [207. Course Schedule](../207-course-schedule/index.md)，采用的方法是任取一个节点，从它出发做深度遍历，如果当前路径上的节点被再次访问到，说明有环。
