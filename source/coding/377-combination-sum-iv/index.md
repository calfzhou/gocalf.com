...
相当于 [322. Coin Change](../322-coin-change/index.md) 的进阶版，从找到最少的硬币数量，改为找出所有可能的方案总数。
...
跟 [problem 322](../322-coin-change/index.md) 几乎一模一样，只是把初始值 `1` 改成 `0`，无解值 $\infty$ 改成 `0`，`1 + min` 改成 `sum`。
