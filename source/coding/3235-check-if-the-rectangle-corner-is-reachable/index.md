...
{% asset_code coding/assets/3235-check-if-the-rectangle-corner-is-reachable/solution_test.py %}
...
{% asset_code coding/assets/3235-check-if-the-rectangle-corner-is-reachable/solution.py %}

Test cases for solution inner methods:

{% asset_code coding/assets/3235-check-if-the-rectangle-corner-is-reachable/solution_inner_test.py %}
