...
如果按 [problem 3291](../3291-minimum-number-of-valid-strings-to-form-target-i/index.md) 中 `O(n²)` 复杂度的 trie 树 + 动态规划是无法 AC 的，需要用更快的 [AC 自动机](../3291-minimum-number-of-valid-strings-to-form-target-i/index.md#Faster%20-%20AC%20自动机)。
